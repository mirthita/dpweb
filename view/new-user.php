    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    <label for="Razón Social" class="col-sm-2 col-form-label">Razón Social :</label>
                    <div class="col-sm-8">
                        <input type="tex" class="form-control" id="Razón social" name="Razón Social" required>
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    <label for="Codigo posta" class="col-sm-2 col-form-label">Codigo postal:</label>
                    <div class="col-sm-8">
                        <input type="number" class="form-control" id="Codigo posta" name="Codigo posta" required>
                        </div>
                        </div>
                <div class="mb-3 row">
